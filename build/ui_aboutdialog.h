...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Nest", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Nest</b> version", 0));
...
"Copyright \302\251 2014 The Nest developers", 0));
