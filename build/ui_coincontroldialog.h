...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 NST"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 NST"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 NST"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 NST"));
